    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-1.5 text-xs"
          ...
          <span className="text-white">Agora há pouco</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 glow-card rounded-xl p-5">
          ...
          {chartLoading ? (
            ...
            <div className="h-52 flex items-center justify-center text-sm" style={{ color: "rgba(255,255,255,0.3)" }}>
              Sem dados ainda
            </div>
          )}
        </div>
            ...
            <div className="flex flex-col items-center gap-4 flex-1">
              <div className="relative shrink-0" style={{ width: 168, height: 168 }}>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  <span className="text-2xl font-extrabold text-white number-display leading-tight">
      ...
      {/* Wallet Bar - CLEAN */}
      <div
        className="rounded-xl px-4 lg:px-6 py-4 flex flex-col lg:flex-row items-start lg:items-center gap-4 lg:gap-4"
        style={{
      ...
      >
        {walletLoading ? (
          <div className="flex-1 w-full"><Skeleton className="h-10 w-full rounded" style={{ background: "rgba(255,255,255,0.04)" }} /></div>
        ) : wallet ? (
          <>
            ...
            <div className="w-full lg:w-px h-px lg:h-10 shrink-0" style={{ background: "rgba(0,230,118,0.1)" }} />
            <div className="flex items-center gap-3 flex-1 w-full">
            ...
            <button
              className="glow-btn w-full lg:w-auto px-6 py-3 rounded-xl text-sm font-extrabold text-black shrink-0 flex items-center justify-center gap-2"
