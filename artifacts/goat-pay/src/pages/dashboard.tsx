...
// ─── TRAFFIC COLORS ──────────────────────────────────────────
const TRAFFIC_COLORS = ["#00e676", "#00c853", "#69f0ae", "#1b5e20", "#aaa"];
...
function GrowthBadge({ value }: { value: number }) {
  ...
  return (
    <span className="inline-flex items-center gap-1 text-xs font-semibold mt-1"
      ...
      {pos ? "+" : ""}{value.toFixed(1)}% <span style={{ color: "rgba(255,255,255,0.4)", fontWeight: 400 }}>vs mês anterior</span>
    </span>
  );
}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-white">Olá, Operador!</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 glow-card rounded-xl p-5">
          ...
          {chartLoading ? <Skeleton className="h-52 w-full rounded-lg" style={{ background: "rgba(255,255,255,0.04)" }} /> :
            chart && chart.length > 0 ? (
              <ResponsiveContainer width="100%" height={220}>
                <AreaChart data={chart} margin={{ top: 8, right: 4, left: 0, bottom: 0 }}>
                  ...
                  <Area
                    ...
                    fill="url(#revGrad)"
                    dot={false}
                    activeDot={{ r: 5, fill: "#00e676", stroke: "#fff", strokeWidth: 2,
              ...
              <div className="h-52 flex items-center justify-center text-sm"
                style={{ color: "rgba(255,255,255,0.3)" }}>Sem dados ainda</div>
            )
          }
        </div>
        ...
        <div className="glow-card rounded-xl p-5 flex flex-col">
          ...
          {trafficLoading ? <Skeleton className="flex-1 rounded-lg" style={{ background: "rgba(255,255,255,0.04)" }} /> :
              ...
              <div className="flex flex-col items-center gap-4 flex-1">
                ...
                <div className="relative shrink-0" style={{ width: 168, height: 168 }}>
                      ...
                      return traffic.map((seg, i) => {
                        ...
                        const el = (
                          <path key={i} d={d} fill={color}
                            style={{ filter: i === 0 ? `drop-shadow(0 0 6px ${color})` : undefined }}
                          />
                        );
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                    <span className="text-xl font-extrabold text-white number-display leading-tight">
                      {totalSalesForDonut.toLocaleString("pt-BR")}
                    </span>
                      ...
                      <div className="flex items-center gap-2">
                        <span className="w-2 h-2 rounded-full shrink-0"
                          style={{ background: TRAFFIC_COLORS[i % TRAFFIC_COLORS.length],
                            boxShadow: `0 0 4px ${TRAFFIC_COLORS[i % TRAFFIC_COLORS.length]}` }} />
        ...
        <div className="glow-card rounded-xl p-5">
          ...
          <div className="rounded-lg mb-4 overflow-hidden flex items-center justify-center"
            ...
            <svg viewBox="0 0 400 200" className="w-full h-full opacity-60" style={{ fill: "none" }}>
              ...
              {/* Brazil highlight */}
              <circle cx="115" cy="115" r="6" fill="#00e676" style={{ filter: "drop-shadow(0 0 6px #00e676)" }} />
            </svg>
          </div>
        ...
        <div className="glow-card rounded-xl p-5 flex flex-col">
          ...
          <div className="flex flex-col items-center gap-4 flex-1">
            <div className="relative shrink-0" style={{ width: 148, height: 148 }}>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                <Monitor className="w-6 h-6" style={{ color: "#00e676", filter: "drop-shadow(0 0 6px #00e676)" }} />
              </div>
            </div>
                ...
                return (
                  <div key={p.id} className="flex items-center gap-2">
                    <span className="text-xs font-black w-4 shrink-0"
                      style={{ color: "#00e676" }}>{p.rank}</span>
                    ...
                    <span className="text-xs font-bold shrink-0 number-display"
                      style={{ color: "#00e676", minWidth: 76, textAlign: "right" }}>
      ...
      {/* ── GOAT-PAY Banner ── */}
      <div
        className="rounded-xl overflow-hidden flex items-center justify-between px-6 py-4"
        style={{
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs" style={{ color: "rgba(255,255,255,0.45)" }}>
              Powered by GOAT-PAY Platform
            </div>
          </div>
        </div>
        <button
          className="glow-btn px-5 py-2 rounded-lg text-sm font-bold text-black"
      ...
      >
        {walletLoading ? (
          ...
          <>
            ...
            {/* Sacar Agora */}
            <button
              className="glow-btn px-7 py-3 rounded-xl text-sm font-extrabold text-black shrink-0 flex items-center gap-2"
